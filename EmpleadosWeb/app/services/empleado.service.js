...
var empleadoService = (function () {
    ...
    empleadoService.prototype.postempleado = function (empleado) {
    ...
    empleadoService.prototype.putempleado = function (empleado) {
        var json = JSON.stringify(empleado);
        var params = json;
        console.log(params);
        var headers = new http_1.Headers({ 'Conent-Type': 'application/json' });
    ...
    empleadoService.prototype.deleteempleado = function (empleado) {
        var json = JSON.stringify(empleado);
        var params = json;
        console.log(params);
        var headers = new http_1.Headers({ 'Conent-Type': 'application/json' });
